// day 12
// create a way to authenicate checkboxes - check
// find a way to dynamically load in more data from the csv in 'dataset' variable - check
// regroup data by basin - check
// join new data to d3 - check
// moved all 'utility' functions into async drawChart function - check
// debug enter/exit/merge 
// add a color scale to each series
...
async function drawChart() {
    ...
    let data = extractSeries(dataset);
    ...
    function updateChart() {
        ...
        slices = slice(data, updates, dateParser);
    ...
    function extractSeries(dataset) {
        let result = [];
